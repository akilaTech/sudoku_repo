...
public class SquareColumn {
	...
	/** initial capacity of square col is 3 */
	private int initSqrColCapacity = 3;
	...
	public int getInitSqrColCapacity() {
		return initSqrColCapacity;
	}
	public void decreaseInitSqrColCapacity() {
		this.initSqrColCapacity = this.initSqrColCapacity -1 ;
	}
}
